                        ...
                        for pattern in MINER_PATTERNS:
                            if pattern in output:
                                ...
                                try:
                                    ...
                                    await owner.send(f"✅ ï¸ Your VPS {vps['vps_id']} has been suspended due to detected mining activity. Contact admin to unsuspend.")
                                except:
                                    pass
                                break
                    except Exception as e:
...
async def setup_container(container_id, status_msg, memory, username, vps_id=None, use_custom_image=False):
    ...
    try:
        ...
        if isinstance(status_msg, discord.Interaction):
            await status_msg.followup.send("✅ï¸ Setting resource limits...", ephemeral=True)
        else:
            await status_msg.edit(content="✅ï¸ Setting resource limits...")
...
async def create_vps_command(ctx, memory: int, cpu: int, disk: int, owner: discord.Member, 
    ...
    try:
        ...
        if use_custom_image:
            ...
            await status_msg.edit(content="✅ï¸ Initializing container...")
            try:
        ...
        try:
            ...
            embed.add_field(name="✅¹ï¸ Note", value="This is a LP NODES VPS instance. You can install and configure additional packages as needed.", inline=False)
...
async def cleanup_vps(ctx):
    ...
    try:
        ...
        if cleanup_count > 0:
            ...
            await ctx.send("✅¹ï¸ No inactive VPS instances found to clean up.")
    except Exception as e:
...
async def emergency_stop(ctx, vps_id: str):
    ...
    try:
        ...
        try:
            ...
            await ctx.send("✅ ï¸ Attempting to force stop the VPS... This may take a moment.", ephemeral=True)
...
async def suspend_vps(ctx, vps_id: str):
    ...
    try:
        ...
        try:
            ...
            await owner.send(f"✅ ï¸ Your VPS {vps_id} has been suspended by an admin. Contact support for details.")
        except:
            pass
